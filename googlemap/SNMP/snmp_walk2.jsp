		...
		<div class="row">
			...
			<!-- Operator selector: -->
				<div id="operator_drag" class="ui-widget-content">
				 	<p> <span class="bts-pwr">Operator: Robi Axiata Ltd.</span><br>
					MW Site Link <span class="mw-link pull-right"></span><br>
					Fiber Site Link <span class="fiber-link pull-right"></span><br>
					MSC  <img height="15" class="pull-right" src="/assets/images/mapAPI/marker_blue.png"><br>
					BTS  <img height="15" class="pull-right" src="/assets/images/mapAPI/marker_green.png"><br>
					</p>
				</div>
				
				<!-- google map container -->
				<div id="siteMWMap"></div>
			</div>
		</div>	
...
//Google Maps 
  ...
  var mapCenter = {lat: btsData[0].btsLatitude, lng: btsData[0].btsLongitude};
    ...
    function initMap() {
      ...
      // Create the map.
      var map = new google.maps.Map(document.getElementById('siteMWMap'), {
        zoom: 12,
        center: mapCenter,
        mapTypeControl: true,
   ...
   // ============== markers and infoWindow for BTS ================================
      ...
      for ( var i = 0; i < btsData.length; i++) {
     	 
    	  bts_latlng = {lat: btsData[i].btsLatitude, lng: btsData[i].btsLongitude};
     	 	
    	  btsContent = '<div class="container site_container">'+
  		      '<div class="row">' +
  		      	   '<div class="col-md-12 text-center">' +
  			          	'<h4>BTS Summary</h4>' +
  			          	'<p> BTS Code: '+ btsData[i].btsCode +
  			 		    ', BTS Name: '+ btsData[i].btsName +
  			 		   '</p>' +
 			        	'<p>BTS Lng/Lat: '+ btsData[i].btsLongitude +'/'+  btsData[i].btsLatitude +
 					    '<br>BTS Altitude: '+ btsData[i].btsAltitudeFt + ' ft' +
 					    '</p>' +
  		        	'</div>' +
  		      '</div>' +
  		 '</div>'	
